...
if len(argv) == 0:
    ...
    try:
        # Fill filePathList (using nautilus/nemo script)
        if 'NEMO_SCRIPT_SELECTED_FILE_PATHS' in os.environ:
            filePathList = os.environ['NEMO_SCRIPT_SELECTED_FILE_PATHS'].splitlines()
        else:
