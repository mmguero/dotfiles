...
if [ -f /.dockerenv ]; then
  ...
  PS1="\`if [ \$? = 0 ]; then echo \[\e[32m\]✔\[\e[0m\]; else echo \[\e[31m\]✘\[\e[0m\]; fi\` \[\e[01;49;39m\]\u\[\e[00m\]\[\e[01;49;39m\]@$(/usr/bin/env bash context-color -c "echo $PROMPT_SEED" -p 2>/dev/null)\h\[\e[0m\]\[\e[00m\] \[\e[1;49;34m\]\W\[\e[0m\] \[\e[38;5;151m\]\$(parse_git_branch 2>/dev/null)\[\e[0m\]▶ "
  [ $WINDOWS10 ] && cd ~
fi
