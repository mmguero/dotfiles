...
# attempt to import requests a few things, will cover failure later
...
###################################################################################################
# take care of importing some things and helping to install them if possibler
...
###################################################################################################
# shallow clone
def GitClone(url, local_dir, debug=False):
  global DynImports
